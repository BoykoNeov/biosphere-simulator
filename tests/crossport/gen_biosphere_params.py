...
def _scalars() -> list[tuple[str, float]]:
    ...
    return [
        ...
        ("nitro.n_target_coefficient", nitro.n_target_coefficient),
        ("nitro.n_target_exponent", nitro.n_target_exponent),
        ("nitro.n_target_w_plateau", nitro.n_target_w_plateau),
        ("nitro.dm_kg_per_mol_c", nitro.dm_kg_per_mol_c),

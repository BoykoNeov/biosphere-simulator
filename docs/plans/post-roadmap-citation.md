...
**Status: COMPLETE** (2026-07-16). The third and last scope of bucket 3
(validation). Scope (A) — diagnose + pin the oracle gap — is COMPLETE
(`post-roadmap-validation.md`). Scope (B) — the full oracle match — remains open and is
